...
declare type ResolveOps = "wait" | "skip" | "drop" | "done";
/**
 ...
 */
export declare function createConversation<C extends Context>(builder: ConversationFn<C>, id?: string): MiddlewareFn<C & ConversationFlavor>;
/**
