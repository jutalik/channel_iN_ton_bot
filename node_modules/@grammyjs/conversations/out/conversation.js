...
function conversationRunner(ctx, builder) {
    ...
    async function run(log) {
        ...
        return (_a = rsr.value) !== null && _a !== void 0 ? _a : "done";
    }
    return run;
}
/**
...
function createConversation(builder, id = builder.name) {
    ...
    return async (ctx, next) => {
        ...
        async function runUntilComplete(conversations) {
            let op = "skip";
            for (let i = 0; (op === "skip" || op === "drop") && i < conversations.length; i++) {
...
class ConversationHandle {
    ...
    _replayApi(method) {
        ...
        const result = (_c = this.opLog.u[this.replayIndex.wait - 1].a) === null || _c === void 0 ? void 0 : _c[method][index];
    ...
    _replayExt() {
        ...
        const result = (_a = this.opLog.u[this.replayIndex.wait - 1].e) === null || _a === void 0 ? void 0 : _a[index];
    ...
    _logApi(method) {
        ...
        const slot = { i: -1 };
        ((_b = (_d = ((_a = (_c = this.opLog.u[index - 1]).a) !== null && _a !== void 0 ? _a : (_c.a = {})))[method]) !== null && _b !== void 0 ? _b : (_d[method] = [])).push(slot);
        return slot;
    }
    /**
    ...
    _logExt() {
        ...
        const index = this.replayIndex.wait;
        const slot = { i: -1 };
        ((_a = (_b = this.opLog.u[index - 1]).e) !== null && _a !== void 0 ? _a : (_b.e = [])).push(slot);
        return slot;
    }
    /**
